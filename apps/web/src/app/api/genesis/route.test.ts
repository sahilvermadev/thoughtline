...
describe("POST /api/genesis", () => {
  it("streams genesis progress and returns mint artifacts without leaking the private worldview", async () => {
    ...
    expect(JSON.stringify(ready)).not.toContain("Private reasoning fingerprint");
