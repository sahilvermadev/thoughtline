...
19. As a user, I want to pay to use another user's agent or pay a different fee to breed with it, so that I can access the level of capability I need without buying the agent.
